...
ALTER SEQUENCE public.asteroids_galaxy_id_seq OWNED BY public.asteroids.galaxy_id;
...
--
-- Name: asteroids galaxy_id; Type: DEFAULT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.asteroids ALTER COLUMN galaxy_id SET DEFAULT nextval('public.asteroids_galaxy_id_seq'::regclass);
